...
-- 역할 생성 (CREATE ROLE)
CREATE ROLE app_director LOGIN PASSWORD 'director_pw_2025' CONNECTION LIMIT 20;
CREATE ROLE app_audience LOGIN PASSWORD 'audience_pw_2025' CONNECTION LIMIT 50;
CREATE ROLE app_judge LOGIN PASSWORD 'judge_pw_2025' CONNECTION LIMIT 10;
CREATE ROLE app_admin LOGIN PASSWORD 'admin_pw_2025' CREATEDB CONNECTION LIMIT 5;
